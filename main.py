...
def main():
    ...
    # 2. Parse & Filter (Only keeping TLS/Reality VLESS/VMESS)
    configs = []
    for line in raw_lines:
        c = Config(line)
        if c.protocol in ["vless", "vmess"] and c.use_tls and c.address:
            # Skip if address is direct IP to avoid bad routing
    ...
    # 5. Apply Your Clean IPs with 3 Ports (443, 2083, 8443)
    clean_ips = []
    ...
    if clean_ips and alive_configs:
        ...
        # Save a Base64 Subscription of Clean IPs
